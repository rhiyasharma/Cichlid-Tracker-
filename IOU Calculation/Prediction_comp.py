...
def initialising():
	...
	annotated_data = 'MC_fem_con2/MasterAnalysisFiles/LabeledFrames.csv'
...
def frames(info):
	#tf = tarfile.open("MC_male_con1.tar")
	#tf.extractall()
	...
	path = '/Users/rhiyasharma/Desktop/McGrathLab/MC_fem_con1/'
...
df = pd.read_csv(ld + 'LabeledFrames.csv')
df=df.fillna('(0,)')
